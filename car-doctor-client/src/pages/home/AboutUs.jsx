    ...
    return (
        <div>
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row max-lg:gap-28">
                    <div className="lg:w-1/2 ">
                        <div className="relative">
                            <img src={person} className="w-3/4 rounded-lg shadow-2xl" />
                            <img src={parts} className="w-2/4 rounded-lg shadow-2xl absolute -bottom-16 right-20 border-8 border-white" />
                        </div>
                    </div>
                    <div className="lg:w-1/2">
