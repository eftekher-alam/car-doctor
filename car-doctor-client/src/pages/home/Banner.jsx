...
const Banner = () => {
    return (
        <div>
            <div className="carousel w-full h-[85vh] rounded-lg">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src={img1} className="w-full rounded-lg" />
                    <div className="absolute h-full p-20 flex justify-center items-center gap-4 text-white bg-gradient-to-r from-[#151515] rounded-lg">
                        <div className="space-y-4">
                            <h1 className="text-7xl w-1/2 font-bold">Affordable Price For Car Servicing</h1>
